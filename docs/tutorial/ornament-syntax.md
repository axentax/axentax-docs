...
後述しますが、組み合わせ次第で各項目を省略でます。\

| 項目         | 説明                                                                                     |
|--------------|------------------------------------------------------------------------------------------|
| 開始位置     | ベンドの開始位置を指定します。全音符を基準にした位置を指定します（例: `0`, `8`など）。     |
| 終了位置     | ベンドの終了位置を指定します。全音符を基準にした位置を指定します（例: `8`, `16`など）。    |
| 分割分音符   | 開始位置と終了位置を決定する基準となる分割数を指定します（例: `/16`, `/8`など）。           |
